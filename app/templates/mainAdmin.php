...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= assets('images/faviconAdmin.png') ?>">
...
<?php if (isAuth()): ?>
    <div class="flex">
        ...
        <div class="content">
                ...
                <div class="user flex-between">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-user" aria-labelledby="user">
                            <li>
                                <a class="dropdown-item" href="/admin/administrator/settings">
            ...
            <div class="footer">
                <div class="copyright"><?= VERSION ?> © <?= YEAR ?></div>
            </div>
        </div>
    </div>
